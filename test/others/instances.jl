...
@testset "Creation of instances" begin
  epm1, epv1 = create_epv_epm(; n = 9, nie = 5, overlapping = 1, mul_m = 5.0, mul_v = 100.0)
  epm2, epv2 = create_epv_epm(; n = 9, nie = 3, overlapping = 0, mul_m = 5.0, mul_v = 100.0)
  ...
  epm3, epv3 = create_epv_epm(; n = 16, nie = 6, overlapping = 1, mul_m = 5.0, mul_v = 100.0)
