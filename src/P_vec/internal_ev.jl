...
module M_internal_elt_vec
	...
	using SparseArrays, LinearAlgebra
 	...
 	using ..M_elt_vec, ..M_elemental_elt_vec
	...
	mutable struct Internal_elt_vec{T} <: Elt_vec{T}
		...
		lin_comb :: SparseMatrixCSC{T,2} # size nᵢᴵ× nᵢᴱ
		nie :: Int
		nii :: Int
	...
	@inline new_iev(nᵢᴱ:: Int, nᵢᴵ:: Int; T=Float64, n=nᵢᴱ^2) = Internal_elt_vec(rand(T,nᵢᴵ),rand(1:n,nᵢᴱ), rand(T,nᵢᴵ, nᵢᴱ), nᵢᴱ, nᵢᴵ, rand(T,nᵢᴱ))
	@inline ones_iev(nᵢᴱ:: Int, nᵢᴵ:: Int; T=Float64, n=nᵢᴱ^2) = Internal_elt_vec(ones(T,nᵢᴵ),rand(1:n,nᵢᴱ), rand(T,nᵢᴵ, nᵢᴱ), nᵢᴱ, nᵢᴵ, rand(T,nᵢᴱ))
	...
	function iev_from_eev(eev :: Elemental_elt_vec{T}) where T 
		...
		vec = get_vec(eev)
		lin_com = zeros(T,nie,nie) # identity matrix Matrix(I,n,n) didn't work
