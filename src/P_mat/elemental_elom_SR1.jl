...
@inline (==)(eelom1::Elemental_elom_sr1{T}, eelom2::Elemental_elom_sr1{T}) where T = (get_nie(eelom1)==get_nie(eelom2)) && (get_indices(eelom1)==get_indices(eelom2)) && begin v=rand(get_nie(eelom1)); (get_Bie(eelom1)*v==get_Bie(eelom2)*v) end
