...
@inline (==)(eplo1::Elemental_plo_sr1{T}, eplo2::Elemental_plo_sr1{T}) where {T} =
  (get_N(eplo1) == get_N(eplo2)) &&
  (get_n(eplo1) == get_n(eplo2)) &&
  (get_eelo_set(eplo1) == get_eelo_set(eplo2)) &&
  (get_permutation(eplo1) == get_permutation(eplo2))
@inline copy(eplo::Elemental_plo_sr1{T}) where {T} = Elemental_plo_sr1{T}(
  copy(get_N(eplo)),
  copy(get_n(eplo)),
...
@inline similar(eplo::Elemental_plo_sr1{T}) where {T} = Elemental_plo_sr1{T}(
  copy(get_N(eplo)),
  copy(get_n(eplo)),
