...
using PartitionedStructures.Utils, PartitionedStructures.Link, PartitionedStructures.PartitionedQuasiNewton
...
using .PartitionedStructures.PartitionedLOQuasiNewton, .PartitionedStructures.ModElemental_elom_bfgs, .PartitionedStructures.ModElemental_plom_bfgs

makedocs(  
	modules = [PartitionedStructures, M_abstract_part_struct, M_abstract_element_struct, M_internal_elt_vec, M_internal_pv, M_elt_vec, ModElemental_ev, ModElemental_pv, M_elt_mat, M_part_mat, ModElemental_pm, ModElemental_em, M_okoubi_koko, M_frontale, M_1_parallel, M_2_parallel, M_3_parallel, Link, Utils, PartitionedQuasiNewton, PartitionedLOQuasiNewton, ModElemental_elom_bfgs, ModElemental_plom_bfgs],
  doctest = true,
  linkcheck = true,
  strict = true,
